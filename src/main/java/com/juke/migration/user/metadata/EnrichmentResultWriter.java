 ...
 */
public class EnrichmentResultWriter implements AutoCloseable {

    private static final ReaktorLogger LOG = ReaktorLogger.getLogger(EnrichmentResultWriter.class);

    private final File outFile;
    private CSVPrinter printer;

    public EnrichmentResultWriter(File outFile) {
        if (outFile == null)
    ...
    public synchronized void writeResult(EnrichmentResult result) {
        try {
            printer.printRecord(

 ...
 */
public class DownloadResultWriter implements AutoCloseable {

    private static final ReaktorLogger LOG = ReaktorLogger.getLogger(DownloadResultWriter.class);

    private final File outFile;
    private CSVPrinter printer;

    public DownloadResultWriter(File outFile) {
        if (outFile == null)
    ...
    public synchronized DownloadResultWriter open() {
    ...
    public synchronized void writeResult(DownloadResult result) {
        try {
            printer.printRecord(
